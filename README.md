# Structural Obstruction of Odd Covering Systems in the 3^a * 5 * p Tower

This repository contains the computational and analytic verification for the paper "Structural Obstruction of Odd Covering Systems in the 3^\infty * 5 * p Tower."

## The Theorem
We definitively prove that no odd covering system exists within the infinite moduli tower 3^\infty * 5 * p for all primes p >= 7. 
...
Since the analytic crossover (3.775) strictly dominates the lowest valid prime in the sequence (p = 7), the entire infinite family is obstructed analytically without the need for piecemeal computational gap-filling.
